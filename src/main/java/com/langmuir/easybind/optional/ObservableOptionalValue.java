...
import com.langmuir.easybind.PropertyBinding;
import com.langmuir.easybind.SimpleChangeListener;
import com.langmuir.easybind.Subscription;
...
public interface ObservableOptionalValue<T> extends ObservableObjectValue<Optional<T>> {
     ...
     * Use {@link #subscribeTo(Consumer)} if you want to be notified about empty values as well.
     *
     ...
     * @see EasyBind#subscribe(ObservableValue, Consumer)
     */
    default Subscription subscribeTo(Consumer<? super Optional<T>> listener) {
